...
export const questions: { text: string; choices: string[] }[] = [
  ...
  {
    text: "주인공이 문제를 해결하기 위해 먼저 무엇을 하나요?",
    choices: [
      "지혜로운 구미호에게 도움을 요청함",
      "마법의 물건을 찾으러 여행을 떠남"
    ]
  ...
  {
    text: "주인공의 여정에서 만나는 동료는 누구인가요?",
    choices: ["말하는 나무", "용감한 기사"]
  },
  {
    text: "이들이 함께 극복해야 할 도전은 무엇인가요?",
    choices: ["거대한 폭풍", "마법의 미로"]
  },
  {
    text: "이야기의 해결 방법은 무엇인가요?",
    choices: ["지혜와 용기를 모아 마법을 사용", "모두가 힘을 합쳐 문제를 해결"]
  },
  {
    text: "주인공이 얻는 교훈은 무엇인가요?",
    choices: [
